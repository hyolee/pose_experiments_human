...
exp = RoschPoseExperiment(htmlsrc = 'rosch_pose_newtiming.html',
                        htmldst = 'rosch_pose_newtiming_'+cats[1]+'_exp3_n%04d.html',
                        othersrc = othersrc,
                        sandbox = False,
                        title = 'Pose Judgement - ' + cats[0] + ',' + cats[1],
                        reward = 0.85,
                        duration = 3600,
                        ...
                        trials_per_hit=NUM_TEST+REPEATS+NUM_TRAIN+REPEATS+LEARNING_PERIOD,#BSIZE + REPEATS + LEARNING_PERIOD,
