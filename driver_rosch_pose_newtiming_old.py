...
class RoschPoseExperiment(Experiment):
    ...
    def createTrials(self):
        ...
        meta_pth = '/om/user/hyo/.skdata/genthor/RoschDataset3_' + cat + '_6eef6648406c333a4035cd5e60d0bf2ecf2606d7/meta.pkl'
        ...
        nObj = round(float(NUM_TEST) / len(objs))
...
exp = RoschPoseExperiment(htmlsrc = 'rosch_pose_newtiming.html',
                        htmldst = 'rosch_pose_newtiming_'+cat+'_n%04d.html',
                        othersrc = othersrc,
                        sandbox = False,
                        title = 'Pose Judgement - ' + cat,
                        reward = 0.45,
                        duration = 2700,
                        ...
                        trials_per_hit=200,#BSIZE + REPEATS + LEARNING_PERIOD,
